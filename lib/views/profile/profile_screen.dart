...
import 'package:seclob_machine_task/views/widgets/profile_shimmer.dart';
        ...
        children: [
          ...
          Consumer<UserProvider>(
            builder: (context, provider, _) {
              ...
              if (user == null) return ProfileShimmer();
              return Container(
          ...
          SettingSwitchItem(icon: Icons.dark_mode_outlined, title: "Darkmode"),
          SettingSwitchItem(
